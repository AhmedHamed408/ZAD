      ...
      builder: (context) {
        return Consumer<TransactionProvider>(
          builder: (context, txProvider, child) {
            final otherUsers = MockUsers.allUsers
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                '${otherUsers.length} ${isAr ? 'جهات اتصال' : 'contacts'} • ZAD Pay',
                                style: TextStyle(
                                  fontSize: 12,
                                  color: isDark
                  ...
                  Expanded(
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        final UserModel user = otherUsers[index];
                        final messages = txProvider.getChatMessages(user.id);
                        final lastMsg = messages.last;
                        final isTransaction = lastMsg.isTransaction;
                          ...
                          subtitle: Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  isTransaction
                                      ? '💸 ${CurrencyFormatter.format(lastMsg.transactionAmount ?? 0, currency: lastMsg.transactionCurrency ?? 'EGP')}'
                                      : lastMsg.message,
                                  maxLines: 1,
